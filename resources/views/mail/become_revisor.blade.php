...
<body>
    <h4>Gentile Admin,</h4>
    <p> L'utente {{ $user->name }} ({{ $user->email }}) richiede di diventare revisore: </p>
    <a href="{{ route('makeRevisor', compact('user')) }}"> Rendi Revisore</a>
    <a href="{{ route('makeRevisor', compact('user')) }}"> <svg viewBox="-523.165 -646.807 1755.454 1920.115"
            width="30px" height="30px" fill="rgb(0,60,200)">
            <g id="SVGRepo_bgCarrier" stroke-width="0" transform="matrix(1, 0, 0, 1, -523.165413, -646.805735)"></g>
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                transform="matrix(1, 0, 0, 1, -523.165413, -646.805735)"></g>
            <g id="SVGRepo_iconCarrier" transform="matrix(1, 0, 0, 1, -523.165413, -646.805735)">
                <path
